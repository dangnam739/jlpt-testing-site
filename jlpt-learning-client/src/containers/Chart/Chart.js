...
class Chart extends Component {
    ...
    componentDidMount(){
        ...
        axios.post(`${process.env.REACT_APP_PORT}/point/list`,{level:'n5'})
        .then(res=>{
            this.setState({n5:res.data.data})
        })
        axios.post(`${process.env.REACT_APP_PORT}/point/list`,{level:'n4'})
        .then(res=>{
            this.setState({n4:res.data.data})
        })
        axios.post(`${process.env.REACT_APP_PORT}/point/list`,{level:'n3'})
        .then(res=>{
            this.setState({n3:res.data.data})
        })
        axios.post(`${process.env.REACT_APP_PORT}/point/list`,{level:'n2'})
        .then(res=>{
            this.setState({n2:res.data.data})
        })
        axios.post(`${process.env.REACT_APP_PORT}/point/list`,{level:'n1'})
        .then(res=>{
